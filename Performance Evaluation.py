...
cl_data = yf.download('CL=F', start='2010-01-01', end='2024-01-01')
g_data = yf.download('NG=F', start='2010-01-01', end='2024-01-01')
...
long_signal = df['Z-Score'] < -3
short_signal = df['Z-Score'] > 3
...
def sharpe_ratio(returns, risk_free_rate=0.02):
    return abs((returns.mean() - risk_free_rate) / returns.std())
